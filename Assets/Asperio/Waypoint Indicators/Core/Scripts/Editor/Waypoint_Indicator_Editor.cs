    ...
    public override void OnInspectorGUI()
    {
        ...
        if (targetScript.enableStandardTracking)
        {
            ...
            if (targetScript.toggleParentOptions)
            {
                ...
                serializedObject.FindProperty("waypointTarget").objectReferenceValue = EditorGUILayout.ObjectField(new GUIContent("Target"), targetScript.waypointTarget, typeof(GameObject), true);
                EditorGUILayout.Separator();
                EditorGUI.indentLevel--;
            }
            else
